...
> 📄 **原文收录** | 机构：Anthropic | 作者：Anthropic 工程团队 | 发布：2025-09-11 | 检索：2026-09-12
...
![Building an evaluation allows you to systematically measure the performance of your tools. You can use Claude Code to automatically optimize your tool](images/fig01.png)
*Building an evaluation allows you to systematically measure the performance of your tools. You can use Claude Code to automatically optimize your tool*
...
![Held-out test set performance of our internal Slack tools](images/fig02.webp)
...
![Held-out test set performance of our internal Asana tools](images/fig03.webp)
...
![Slack threads and thread replies are identified by unique thread_ts which are required to fetch thread replies. thread_ts and other IDs ( channel_id ,](images/fig05.webp)
*Slack threads and thread replies are identified by unique thread_ts which are required to fetch thread replies. thread_ts and other IDs ( channel_id ,*
...
![Tool truncation and error responses can steer agents towards more token-efficient tool-use behaviors (using filters or pagination) or give examples of](images/fig08.webp)
*Tool truncation and error responses can steer agents towards more token-efficient tool-use behaviors (using filters or pagination) or give examples of*
