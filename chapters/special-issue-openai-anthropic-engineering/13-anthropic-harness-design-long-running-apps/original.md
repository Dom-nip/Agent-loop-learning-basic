...
> 📄 **原文收录** | 机构：Anthropic | 作者：Anthropic 工程团队 | 发布：2026-03-24 | 检索：2026-09-12
...
> 🎬 原文此处为演示视频，静态存档无法承载视频内容，请观看原页：https://www.anthropic.com/engineering/harness-design-long-running-apps
...
![Initial screen when opening the app created by the solo harness.](images/fig02.webp)
*Initial screen when opening the app created by the solo harness.*

![Creating a sprite in the sprite editor made by the solo harness](images/fig03.webp)
*Creating a sprite in the sprite editor made by the solo harness*

![Trying unsuccessfully to play the level I created](images/fig04.png)
...
![Initial screen: Creating a new game, in the app built with the full harness](images/fig05.webp)
*Initial screen: Creating a new game, in the app built with the full harness*

![The sprite editor felt cleaner and easier to use](images/fig06.webp)
*The sprite editor felt cleaner and easier to use*

![Using the built in AI feature to generate the level](images/fig07.png)
*Using the built in AI feature to generate the level*

![Using the built in AI feature to generate the level](images/fig08.webp)
*Using the built in AI feature to generate the level*

![Playing the game I generated](images/fig09.webp)
