...
> 📄 **原文收录** | 机构：OpenAI | 作者：Ryan Lopopolo（Member of Technical Staff） | 发布：2026-02-11 | 检索：2026-09-12
> 来源：https://openai.com/index/harness-engineering/
> 本档案为原文全文转载，仅供个人学习使用，版权归原作者所有，请勿再分发。
February 11, 2026
[Engineering](https://openai.com/engineering/)
...
![Codex drives the app](images/fig01.webp)
*Codex drives the app*
...
![Giving Codex a full observability stack](images/fig02.svg)
...
![The limits of agent knowledge](images/fig03.webp)
...
Pulling more of the system into a form the agent can inspect, validate, and modify directly increases leverage—not just for Codex, but for other agents (e.g. [Aardvark](https://www.anthropic.com/index/introducing-aardvark/)) that are working on the codebase as well.
...
![Layered domain architecture with explicit cross-cutting boundaries](images/fig04.webp)
...
As agents like Codex take on larger portions of the software lifecycle, these questions will matter even more. We hope that sharing some early lessons helps you reason about where to invest your effort so [you can just build things](https://www.anthropic.com/codex/).

- [Codex](https://www.anthropic.com/news/?tags=codex)
- [2026](https://www.anthropic.com/news/?tags=2026)
...
### Keep reading
[View all](https://www.anthropic.com/news/)

![](images/fig05.webp)
[Jalapeño’s first results show industry-leading speed and efficiency in AI inference

EngineeringAug 25, 2026](https://www.anthropic.com/index/jalapeno-first-results/)

![](images/fig06.webp)
[Continuous voice interaction with GPT Live

EngineeringAug 3, 2026](https://www.anthropic.com/index/continuous-voice-interaction-with-gpt-live/)

![](images/fig07.webp)
[How GPT-5.6 fuses frontier intelligence with frontier efficiency

EngineeringJul 29, 2026](https://www.anthropic.com/index/gpt-5-6-frontier-intelligence-efficiency/)
